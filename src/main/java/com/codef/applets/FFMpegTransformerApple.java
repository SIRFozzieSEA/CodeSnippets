...
public class FFMpegTransformerApple {

	private static final boolean ENABLE_MAIN_METHOD = true;
	private static final Logger LOGGER = LogManager.getLogger(FFMpegTransformerApple.class.getName());

	private static final String SOURCE_FOLDER = "E:\\MOV";
